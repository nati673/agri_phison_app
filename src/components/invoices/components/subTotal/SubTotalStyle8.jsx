...
export default function SubTotalStyle8({ subTotal, discountPersent, discountAmount, taxPersent, taxAmount, grandTotal }) {
    return (
        <table>
            <tbody>
                <tr className="tm_gray_bg tm_border_top">
                ...
                <tr className="tm_border_top tm_border_bottom tm_gray_bg">

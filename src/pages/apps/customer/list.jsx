...
function ReactTable({ data, columns, modalToggler }) {
  ...
  const [sorting, setSorting] = useState([{ id: 'customer_id', desc: false }]);
        ...
        cell: ({ row, getValue }) => (
          <Stack direction="row" spacing={1.5} alignItems="center">
            ...
            <Stack spacing={0}>
              ...
              <Typography color="text.secondary">{row.original.customer_phone}</Typography>
            </Stack>
          </Stack>
        )
      },
              ...
              <Tooltip title="Delete">
                <IconButton
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    handleClose();
                    setCustomerDeleteId(Number(row.original.customer_id));
                  }}
                >
                  <Trash />
                </IconButton>
